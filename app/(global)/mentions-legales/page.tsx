...
import { ChevronDown } from "@/assets/icons/mdi-chevron-down";
...
export default function MentionsLegales() {
  ...
  return (
    <section>
      ...
      <BreadcrumbHomepage className="bg-secondary text-black" />
      <div className="w-full bg-secondary px-4 py-20 ph:px-24 md:px-48 lg:px-72 xl:px-96">
