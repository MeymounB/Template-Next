...
export const cookiesData: CookieArticle[] = [
  {
    ...
    content: [
      {
        mainText:
          "Le site espacecadet.com utilise uniquement des cookies essentiels pour garantir son bon fonctionnement. Nous respectons votre vie privée et n'utilisons aucun cookie publicitaire ou de traçage.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      {
        contactInfo: "contact@next-generation.dev",
      },
    ],
  },
];
